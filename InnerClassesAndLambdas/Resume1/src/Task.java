...
Create a new Experience object and add it to the resume.*/
        Resume.Experience exp = new Resume.Experience("cashier", 2018, 2019);
        r.addExperience(exp);/* TODO
Create a new experience object on the fly, inside the addExperiece call.*/
        r.addExperience(new Resume.Experience("Optician", 2020, 2021));
        r.addExperience(new Resume.Experience("Data Analyst", 2021, 2022));/* TODO
